...
local Window = OrionLib:MakeWindow({Name = "PL7 XITS 2.702.632", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "PL7 XITS 2.702.632"})

OrionLib:MakeNotification({
	Name = "PL7 XITS 2.702.632",
...
W:AddLabel("[+] PL7 XITS 2.702.632 is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "PL7 XITS 2.702.632(Noitification)",
